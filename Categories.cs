...
namespace MoreCityStatistics
{
    ...
    public class Categories : List<Category>
    {
        ...
        public void Initialize()
        {
            ...
            category.Statistics.Add(new Statistic(category, Statistic.StatisticType.ElectricityConsumptionPercent,              Translation.Key.Consumption,            Translation.Key.None,           Translation.Key.PctOfProduction,            colorElectricity1           ));
            category.Statistics.Add(new Statistic(category, Statistic.StatisticType.ElectricityConsumption,                     Translation.Key.Consumption,            Translation.Key.None,           Translation.Key.MegaWatts,                  colorElectricity1           ));
            category.Statistics.Add(new Statistic(category, Statistic.StatisticType.ElectricityProduction,                      Translation.Key.Production,             Translation.Key.None,           Translation.Key.MegaWatts,                  colorElectricity2           ));
